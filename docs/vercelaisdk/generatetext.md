...
[AI SDK Core](https://sdk.vercel.ai/docs/ai-sdk-core)Generating Text
...
You can generate text using the [`generateText`](https://sdk.vercel.ai/docs/reference/ai-sdk-core/generate-text) function. This function is ideal for non-interactive use cases where you need to write text (e.g. drafting email or summarizing web pages) and for agents that use tools.
...
AI SDK Core provides the [`streamText`](https://sdk.vercel.ai/docs/reference/ai-sdk-core/stream-text) function which simplifies streaming text from LLMs:
...
You can use `streamText` on its own or in combination with [AI SDK UI](https://sdk.vercel.ai/examples/next-pages/basics/streaming-text-generation) and [AI SDK RSC](https://sdk.vercel.ai/examples/next-app/basics/streaming-text-generation). The result object contains several helper functions to make the integration into [AI SDK UI](https://sdk.vercel.ai/docs/ai-sdk-ui) easier:
...
The AI SDK Core provides a [`smoothStream` function](https://sdk.vercel.ai/docs/reference/ai-sdk-core/smooth-stream) that can be used to smooth out text streaming.
