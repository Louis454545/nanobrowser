...
OpenAI has introduced the `o1` and `o3` series of [reasoning models](https://platform.openai.com/docs/guides/reasoning). Currently, `o3-mini`, `o1`, `o1-mini`, and `o1-preview` are available.
