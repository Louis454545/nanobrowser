...
[AI SDK Providers](https://sdk.vercel.ai/providers/ai-sdk-providers)Anthropic
...
Anthropic language models can also be used in the `streamText`, `generateObject`, and `streamObject` functions (see [AI SDK Core](https://sdk.vercel.ai/docs/ai-sdk-core)).
