...
[AI SDK Core](https://sdk.vercel.ai/docs/ai-sdk-core)Provider & Model Management
...
The AI SDK offers [custom providers](https://sdk.vercel.ai/docs/reference/ai-sdk-core/custom-provider) and a [provider registry](https://sdk.vercel.ai/docs/reference/ai-sdk-core/provider-registry) for this purpose:
...
You can mix and match custom providers, the provider registry, and [middleware](https://sdk.vercel.ai/docs/ai-sdk-core/middleware) in your application.

[Custom Providers](#custom-providers)
-------------------------------------

You can create a [custom provider](https://sdk.vercel.ai/docs/reference/ai-sdk-core/custom-provider) using `customProvider`.
...
You can create a [provider registry](https://sdk.vercel.ai/docs/reference/ai-sdk-core/provider-registry) with multiple providers and models using `createProviderRegistry`.
